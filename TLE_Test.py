...
# Data structure to hold history based on bounded positions (0, 90, 180, 270)
# Note: 360 is normalized to 0 for a cleaner statistical log
grouped_data = defaultdict(list)
BOUNDED_STEPS = [0, 90, 180, 270]
...
try:
    with open(CSV_FILENAME, mode='w', newline='', encoding='utf-8') as csv_file:
        ...
        for cycle in range(1, TOTAL_CYCLES + 1):
            ...
            # Perform 4 moves per cycle to trace a full circle (0, +90, +90, +90)
            for _ in range(4):
                ...
                # Normalize target for the spreadsheet log (e.g., 450 becomes 90)
                ...
                # Advance the global absolute step angle forward by 90 degrees
                absolute_target += 90
