...
# --- Configuration ---
CSV_FILENAME = "Failed_TMR_new_reset69_sampling.csv"
...
plt.suptitle(f"GMR Sensor Linear Axis Repeatability Report ({len(df)//4} Complete Cycles)", fontsize=16, fontweight='bold', y=0.96)
plt.show()
